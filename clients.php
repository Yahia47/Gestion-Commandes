...
<body class="d-flex flex-column h-100"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <?php
    // $query = "select * FROM client as c,wilayas as w where c.wilaya_id=w.id_wilaya";
    $query = "SELECT c.id_client, c.nom, c.telephone, w.nom_wilaya AS nom_wilaya
                FROM client c
                JOIN wilayas w ON c.wilaya_id = w.id_wilaya";
    ...
    ?>
    <table id="datatable_client" class="display">
        <thead>
            <tr>
                <th>ID</th>
                <th>NOM</th>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        </svg><?php echo $ligne['nom_wilaya']; ?>
                    </td>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z" />
                        </svg><?php echo $ligne['telephone']; ?>
                    </td>

                    <td>
                        <a href="updateClient.php?id=<?php echo $ligne['id_client']; ?>" class="btn btn-success">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"></path>
                            </svg>
                        </a>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" <?php if (in_array($ligne['id_client'], $list)) {
                                                                                                echo "disabled";
                ...
                <div class="modal fade" id="deleteModal<?php echo $count ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Voulez vous vraient supprimer ce Cleint ?
                            </div>
                            <div class="modal-footer">
    ...
    <script>
        $(document).ready(function() {
            if (!$.fn.DataTable.isDataTable('#datatable_client')) {

...
FROM client
JOIN wilayas ON client.wilaya_id = wilayas.id_wilaya
...
JOIN article ON ligne_de_commande.id_article = article.id_article";
    ...
    <div class="navbar-nav ms-auto">
        ...
        <table id="datatable_index" class="display">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td>
                            <a href="details.php?id=<?php echo $ligne['id_commande'] ?>">
                        ...
                        <td>
                            ...
                            <?php echo $ligne['nom_wilaya']; ?>
                        </td>
                        <td>
                            <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;" width="16" height="16" fill="currentColor" class="bi bi-calendar-date-fill" viewBox="0 0 16 16">
    ...
    <script>
        $(document).ready(function() {
            if (!$.fn.DataTable.isDataTable('#datatable_index')) {

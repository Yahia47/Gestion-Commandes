...
<body class="d-flex flex-column h-100"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    $count = 0;
    $list = [];
    $query = "SELECT id_article FROM article WHERE id_article IN (SELECT id_article 
    FROM ligne_de_commande
     WHERE ligne_de_commande.id_article = article.id_article)
     or id_article in (select id_article
     from images 
    ...
    ?>
    <!-- Liste des articles   -->
    <table id="datatable_articles" class="display border-1">
        <thead>
            <tr>
                <th>ID</th>
                <th>Description</th>
            ...
            ?>
                <tr>
                    ...
                    <td> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-euro" viewBox="0 0 16 16">
                        ...
                        </svg><?php echo $ligne['prix_unitaire']; ?></td>
                    <td>
                        <a href="updateArticle.php?id=<?php echo $ligne['id_article']; ?>" class="btn btn-success">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"></path>
                            </svg>
                        </a>
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" <?php if (in_array($ligne['id_article'], $list)) {
                                                                                                echo "disabled";
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Voulez vous vraient supprimer ce Produit ?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                                <a href="Delete.php?id_art=<?php echo $ligne['id_article'] ?>" class="btn btn-danger ">Supprimer</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            if (!$.fn.DataTable.isDataTable('#datatable_articles')) {
